...
if __name__ == '__main__':
    modelname = "Noisey2SpeechLargeDB2.h5"
    fileIn = "C:\Projects\Year4\FYP\TFsep\\test files\MixSample.wav"
    fileOut = "C:\Projects\Year4\FYP\TFsep\\test files\PredictedSample.wav"
